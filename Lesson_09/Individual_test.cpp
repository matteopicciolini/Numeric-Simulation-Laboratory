...
void Individual_test::swap_test(){
    ...
    correct_chromosome.set_genes(gen_swap);
    chromosome.swap(1, 2);
...
void Individual_test::reverse_test(){
    ...
    Individual correct_chromosome;
    correct_chromosome.set_genes(gen_reverse);
...
void Individual_test::permutate_test(){
    ...
    Individual correct_chromosome;
    correct_chromosome.set_genes(gen_permut);
...
void Individual_test::shift_test(){
    ...
    Individual correct_chromosome;
    correct_chromosome.set_genes(gen_shift);
